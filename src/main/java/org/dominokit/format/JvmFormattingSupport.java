 ...
 * facade can instantiate one support type. JVM executions receive delegates backed by {@link
 * DecimalFormat} and {@link SimpleDateFormat}; GWT keeps a compatible inheritance path through the
 * base GWT support class.
 */
