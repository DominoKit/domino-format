 ...
 *
 * <p>The core formatter can always process string, literal, boolean, and unpatterned values. When a
 * template includes patterns such as {@code $N(000)} or {@code $T(yyyy-MM-dd)}, the formatter
